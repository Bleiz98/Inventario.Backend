...
//        [HttpPost]
//        public async Task<IActionResult> Edit(int id, ProducesAttribute producto)
//        {
//            if (!ModelState.IsValid)
//            { 
//                var json = JsonConvert.SerializeObject(producto);
...
//                if (response.IsSuccessStatusCode)
//                {
//                    TempData["AlertMessage"] = "¡Producto editadop exitosamente!";
//                    return RedirectToAction("Index");
//                }
//                else
//                {
...
//                else
//                {
//                    TempData["ErrorMessage"] = "Error al crear la salida";
//                }
//            }
//            return View(producto);
//        }
...
//                else
//                {
//                    TempData["ErrorMessage"] = "Error al crear la entrada";
//                }
//            }
//            return View(producto);
//        }
